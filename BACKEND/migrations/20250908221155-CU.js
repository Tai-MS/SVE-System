...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const baseMATERIAsDS = MATERIAsDS.map((m) => ({ ...m, carrera_id_fk: "DS", activo: true }))
    const baseMATERIAsAF = MATERIAsAF.map((m) => ({ ...m, carrera_id_fk: "AF", activo: true }))
    const baseMATERIAsITI = MATERIAsITI.map((m) => ({ ...m, carrera_id_fk: "ITI", activo: true }))
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkDelete("unidades_curriculares", { carrera_id_fk: "DS", nombre: { [Op.in]: nombresDS } })
    await queryInterface.bulkDelete("unidades_curriculares", { carrera_id_fk: "AF", nombre: { [Op.in]: nombresAF } })
    await queryInterface.bulkDelete("unidades_curriculares", { carrera_id_fk: "ITI", nombre: { [Op.in]: nombresITI } })
